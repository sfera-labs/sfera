...
public abstract class SocketListner extends Task {
	...
	public SocketListner(WebServer webServer, String protocolName, ArrayBlockingQueue<Connection> connectionsQ) throws Exception {
	...
	@Override
	public void execute() {
		webServer.getLogger().info("accepting connections on port " + serverSocket.getLocalPort());
		Socket s = null;
		try {
			while (true) {
