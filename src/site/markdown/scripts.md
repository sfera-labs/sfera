...
The nodes and respective events generated by drivers and apps are described in the drivers/apps' documentations.    
Refer to [System events](system-events.html) for a list of all the events triggered by Sfera.
...
#### Drivers
Each driver instance is referenced by a variable named as the instance ID.    
You can call all the public methods exposed by the driver, which generally have names similar to the corresponding events IDs it generates.
