...
public interface SferaScriptGrammarListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterLocalScopeInit(SferaScriptGrammarParser.LocalScopeInitContext ctx);
	/**
	 * Exit a parse tree produced by {@link SferaScriptGrammarParser#localScopeInit}.
	 * @param ctx the parse tree
	 */
	void exitLocalScopeInit(SferaScriptGrammarParser.LocalScopeInitContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void exitGlobalScopeInit(SferaScriptGrammarParser.GlobalScopeInitContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SferaScriptGrammarParser#terminalNode}.
	 * @param ctx the parse tree
	 */
	void enterTerminalNode(SferaScriptGrammarParser.TerminalNodeContext ctx);
	/**
	 * Exit a parse tree produced by {@link SferaScriptGrammarParser#terminalNode}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link SferaScriptGrammarParser#parameters}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link SferaScriptGrammarParser#paramsList}.
	 * @param ctx the parse tree
	 */
