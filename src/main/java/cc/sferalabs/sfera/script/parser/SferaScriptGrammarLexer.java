...
public class SferaScriptGrammarLexer extends Lexer {
	...
	public static final String[] ruleNames = {
		...
		"Script", "BooleanLiteral", "Unknown", "NodeId", "NodeFirstLetter", "LetterOrDigit", 
		"NumberLiteral", "StringLiteral", "DoubleQuotesStringCharacters", "SingleQuotesStringCharacters", 
