...
public class SferaScriptGrammarParser extends Parser {
	...
	public static final int
		RULE_parse = 0, RULE_imports = 1, RULE_importLine = 2, RULE_init = 3, 
	...
	public static final String[] ruleNames = {
		"parse", "imports", "importLine", "init", "rules", "ruleLine", "action", 
		"trigger", "orExpression", "andExpression", "notExpression", "atomExpression", 
		"event", "stableEvent", "stringComparison", "numberComparison", "booleanComparison", 
		"unknownComparison", "transientEvent", "terminalNode", "subNode", "parameters", 
	...
	public final ParseContext parse() throws RecognitionException {
		...
		try {
			...
			setState(57);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << NodeId) | (1L << NOT))) != 0)) {
				{
				setState(56);
				rules();
				}
	...
	public static class ImportsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SferaScriptGrammarListener ) ((SferaScriptGrammarListener)listener).enterImports(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SferaScriptGrammarListener ) ((SferaScriptGrammarListener)listener).exitImports(this);
		}
	}
	...
	public static class ImportLineContext extends ParserRuleContext {
		public TerminalNode ImportLine() { return getToken(SferaScriptGrammarParser.ImportLine, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SferaScriptGrammarListener ) ((SferaScriptGrammarListener)listener).enterImportLine(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SferaScriptGrammarListener ) ((SferaScriptGrammarListener)listener).exitImportLine(this);
		}
	}
	...
	public final RulesContext rules() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << NodeId) | (1L << NOT))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ParametersContext parameters() throws RecognitionException {
		...
		try {
			...
			setState(157);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__6) | (1L << BooleanLiteral) | (1L << NodeId) | (1L << NumberLiteral) | (1L << StringLiteral))) != 0)) {
				{
				setState(156);
				paramsList();
				}
